...
{block name="subcontent"}
	...
	<div class="container">
		<div class="readable-width">
            ...
            {if $csv}<p>If the download does not begin automatically, <a href="../generate-csv.php?data={$csv|escape:'url'}&filename={$filename|escape:'url'}">click here.</a><iframe src="../generate-csv.php?data={$csv|escape:'url'}&filename={$filename|escape:'url'}" style="display: none;"></iframe></p>{/if}
		</div>
	</div>
