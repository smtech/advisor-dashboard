    ...
    <div class="container">
        <div class="readable-width">
            ...
            <table class="table">
                <tbody>
                    <tr>
                        <td><a class="btn btn-warning" href="create-advisor-observers.php">Create Advisor Observers</a></td>
                    ...
                    <tr>
                        <td><a class="btn btn-warning" href="rename-advisory-groups.php">Rename Advisory Groups</a></td>
                    ...
                    <tr>
                        <td><a class="btn btn-danger" href="prune-old-observers.php">Prune Old Observers</a></td>
